...
/*   Updated: 2026/02/22 08:19:08 by vitosant         ###    ########.fr      */
/*                                                                            */
/* ************************************************************************** */
...
// 	// cylinder->diam = 0.3; 
// 	// cylinder->height = 1.4;
// 	// cylinder->pos = vec4_init(0, 0, -1, 1); 
// 	// cylinder->norm = vec4_unit_vector(vec4_init(1, 0, 0, 0)); 
...
// 	// cylinder->mat.pattern = GRADIENT;
// 	// cylinder->transform = cy_transform(cylinder, &cylinder->inverse);
// 	// print_mtx(cylinder->transform);
// 	// printf("\n================\n");
// 	// print_mtx(cylinder->inverse);
